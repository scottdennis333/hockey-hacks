let mapPlayer,mergeObjects,flattenObject,mapPlayers;_4bb‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);_4bb‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);_4bb‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);_4bb‍.w("./gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);



       function mapTeam(t) {
  const team = _4bb‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  return _4bb‍.a("mapPlayers",mapPlayers)(players);
}
